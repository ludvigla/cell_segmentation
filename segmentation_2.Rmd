...
```{r}
img.files <- c("/Users/micrat/OneDrive/Mac/Desktop/1_Work_KI/Projects/1_LV-tracing/V13-V16/data/images/V13/olig2.tif", "/Users/micrat/OneDrive/Mac/Desktop/1_Work_KI/Projects/1_LV-tracing/V13-V16/data/images/V13/egfp.tif", "/Users/micrat/OneDrive/Mac/Desktop/1_Work_KI/Projects/1_LV-tracing/V13-V16/data/images/V13/neun.tif")
...
fts.shape.olig2_neun_egfp <- computeFeatures.shape(olig2_neun_egfp)
...
cat("Total number of Egfp+ cells after cleaning: ", sum(nrow(fts.shape.neurons) + nrow(fts.shape.oligodenrocytes) + nrow(fts.shape.unknown) + nrow(fts.shape.olig2_neun_egfp)))
```


There are still a couple of EGFP cells too many compared to the previously detected ones (4166-4025) = 141: 
Total number of Egfp+ cells after cleaning:  4166
Total number of EGFP:  4025 

These are most likely overlapping Olig2, Neun and Egfp which have been counted twice. By removing the overlapping Olig2 and Neun we can probably get rid of these, but these are quite few so maybe it’s good enough?
...
```{r}
work.dir <- "/Users/micrat/OneDrive/Mac/Desktop/1_Work_KI/Projects/1_LV-tracing/V13-V16/data/spaceranger/"
...
v13$celltype <- spots$egfp_positive_nucleus_celltype
...
SpatialDimPlot(v13, group.by = "cloneID")
```
