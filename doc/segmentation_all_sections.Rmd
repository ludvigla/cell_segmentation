...
# list input files
img.files.list <- list(
  v13 = list.files(pattern = "olig2.tif|neun.tif|egfp.tif", path = "../data/IF/V13", recursive = T, full.names = T),
  v14 = list.files(pattern = "olig2.tif|neun.tif|egfp.tif", path = "../data/IF/V14", recursive = T, full.names = T),
  v15 = list.files(pattern = "olig2.tif|neun.tif|egfp.tif", path = "../data/IF/V15", recursive = T, full.names = T),
  v16 = list.files(pattern = "olig2.tif|neun.tif|egfp.tif", path = "../data/IF/V16", recursive = T, full.names = T)
)
...
```{r read_segmented, eval=FALSE, include=FALSE}
